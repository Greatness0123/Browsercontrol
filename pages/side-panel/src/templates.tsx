...
export const defaultTemplates = [
  {
    ...
    content:
      "Open the Control repository at https://github.com/nanobrowser/nanobrowser and check if you've already starred it. If not, please support us by giving us a star!",
  },
  {
    id: '2',
