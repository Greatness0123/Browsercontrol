...
const SidePanel = () => {
  ...
  return (
    <div>
      <div
        className={`flex h-screen flex-col ${isDarkMode ? 'bg-slate-900' : 'bg-white'} overflow-hidden border ${isDarkMode ? 'border-sky-800' : 'border-gray-200'} rounded-2xl`}>
          ...
          <div className="header-logo">
            {showHistory ? (
              <button
                ...
                className={`${isDarkMode ? 'text-white-400 hover:text-gray-300' : 'text-black-400 hover:text-gray-500'} cursor-pointer`}
            ...
            {!showHistory && (
              <>
                ...
                <button
                  ...
                  className={`header-icon ${isDarkMode ? 'text-white-400 hover:text-gray-300' : 'text-black-400 hover:text-gray-500'} cursor-pointer`}
        ...
        {showHistory ? (
          ...
          <>
            <div
              className={`scrollbar-gutter-stable message-list-container flex-1 overflow-x-hidden overflow-y-scroll scroll-smooth p-2 ${isDarkMode ? 'bg-slate-900/80' : ''}`}>
