                    ...
                    <div
                      ...
                      <p className={`text-sm ${isDarkMode ? 'text-gray-200' : 'text-gray-700'}`}>
                        ...
                        <a
                          ...
                          className={`ml-1 ${isDarkMode ? 'text-blue-400 hover:text-blue-300' : 'text-black-600 hover:text-gray-800'}`}>
                          Learn more
                        </a>
                      </p>
                    </div>
          ...
          <div className="provider-selector-container relative pt-4">
            <Button
              ...
              className={`flex w-full items-center justify-center font-medium ${
                isDarkMode
                  ? 'border-black-700 bg-gray-600 text-white hover:bg-gray-500'
                  : 'border-gray-200 bg-gray-100 text-black-800 hover:bg-gray-200'
              }`}>
              ...
              <div
                ...
                <div className="py-1">
                    ...
                    .map(type => (
                      <button
                        ...
                        className={`flex w-full items-center px-4 py-3 text-left text-sm ${
                          isDarkMode
                            ? 'text-black-200 hover:bg-black-600/30 hover:text-white'
                            : 'text-black-700 hover:bg-white-100 hover:text-black-800'
                  ...
                  <button
                    ...
                    className={`flex w-full items-center px-4 py-3 text-left text-sm ${
                      isDarkMode
                        ? 'text-blue-200 hover:bg-black-600/30 hover:text-white'
                        : 'text-black-700 hover:bg-white-100 hover:text-black-800'
                    } transition-colors duration-150`}
